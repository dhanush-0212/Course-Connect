      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mb-6 text-gray-700">
            ...
            through the course list below and learn more about each course.
            To register for a course, please login or create an account.
          </p>
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p>
                    <span className="font-medium">Trainer:</span> {course.trainer}
                  </p>
                  <p>
